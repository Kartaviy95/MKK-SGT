...
for "_i" from 0 to 9 do {
    _saveLinks = _saveLinks + format [" <execute expression='%1 call %2'>[%1]</execute>", _i, QEFUNC(map_tools,saveMarkers)];
    _loadLinks = _loadLinks + format [" <execute expression='%1 call %2'>[%1]</execute>", _i, QEFUNC(map_tools,loadSavedMarkers)];
};
