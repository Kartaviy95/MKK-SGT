...
for "_i" from 0 to GVAR(allMarkersCounter) do {
    private _marker = format [QGVAR(saved_%1), _i];
...
profileNamespace setVariable [format [QGVAR(savedMarkers_%1), _slot], _markersToSave];
